...
$routes -> get('/creer-utilisateur', 'Utilisateur::creerForm', ['filter' => 'isConnected']); //FORMULAIRE CREER UTILISATEUR
$routes -> post('/creer-utilisateur', 'Utilisateur::creer', ['filter' => 'isConnected']); //FORMULAIRE CREER UTILISATEUR
